...
+ (void)fetchData {
    ...
    [groups addObject:[[ObjectiveGroup alloc] initWithScoreMult:1.25 starReward:1200
    ...
    [groups addObject:[[ObjectiveGroup alloc] initWithScoreMult:1.3 starReward:1400
    ...
    [groups addObject:[[ObjectiveGroup alloc] initWithScoreMult:1.35 starReward:1600
    ...
    [groups addObject:[[ObjectiveGroup alloc] initWithScoreMult:1.4 starReward:1800
    ...
    [groups addObject:[[ObjectiveGroup alloc] initWithScoreMult:1.45 starReward:2000
    ...
    [groups addObject:[[ObjectiveGroup alloc] initWithScoreMult:1.5 starReward:2200
    ...
    [groups addObject:[[ObjectiveGroup alloc] initWithScoreMult:1.55 starReward:2500
    ...
    [groups addObject:[[ObjectiveGroup alloc] initWithScoreMult:1.6 starReward:3000
