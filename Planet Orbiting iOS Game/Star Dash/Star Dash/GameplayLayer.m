...
- (id)init {
	...
	if ((self = [super init])) {
        ...
        [((AppController*)[[UIApplication sharedApplication]delegate]) setGalaxyCounter:0];
        isInTutorialMode = [((AppController*)[[UIApplication sharedApplication]delegate]) getIsInTutorialMode];
        isInTutorialMode = false;
        levelNumber = [((AppController*)[[UIApplication sharedApplication]delegate])getChosenLevelNumber];
        ...
        if ([((AppController*)[[UIApplication sharedApplication]delegate]) getIsRetinaDisplay])
...
- (void) Update:(ccTime)dt {
    ...
    if (!paused&&[((AppController*)[[UIApplication sharedApplication]delegate])getWasJustBackgrounded])
    {
        //NSLog(@"startx2");
        [((AppController*)[[UIApplication sharedApplication]delegate])setWasJustBackgrounded:false];
        //NSLog(@"startx3");
        [self togglePause];
        //NSLog(@"startx4");
    }
...
- (void)restartGame {
    ...
    [((AppController*)[[UIApplication sharedApplication]delegate])setIsInTutorialMode:FALSE];
