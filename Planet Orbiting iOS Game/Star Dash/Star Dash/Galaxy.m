...
-(id)initWithSegments:(NSArray *)levelsegments{
    if ((self = [super init])) {
        ...
        self.number = [((AppController*)[[UIApplication sharedApplication]delegate]) getGalaxyCounter];
        [((AppController*)[[UIApplication sharedApplication]delegate]) setGalaxyCounter:self.number+1];
